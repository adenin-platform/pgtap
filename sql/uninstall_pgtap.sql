...
DROP FUNCTION IF EXISTS _retval(TEXT);
...
DROP FUNCTION IF EXISTS index_is_partial ( NAME );
DROP FUNCTION IF EXISTS index_is_partial ( NAME, NAME );
DROP FUNCTION IF EXISTS index_is_partial ( NAME, NAME, NAME );
DROP FUNCTION IF EXISTS index_is_partial ( NAME, NAME, NAME, text );
...
DROP FUNCTION IF EXISTS col_is_pk ( NAME, NAME, NAME );
...
DROP FUNCTION IF EXISTS has_pk ( NAME, NAME );
...
DROP FUNCTION IF EXISTS format_type_string ( TEXT );
DROP FUNCTION IF EXISTS _typename ( NAME );
...
DROP FUNCTION IF EXISTS hasnt_composite ( NAME, NAME );
...
DROP FUNCTION IF EXISTS has_composite ( NAME, NAME );
